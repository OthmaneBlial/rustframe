...
| The frontend package cannot install | `rustframe-api@0.1.0-rc.4` has not completed its initial npm publication | Check the release status. Do not substitute a repository path in a public-project test. |
