...
const DOCS = {
    ...
    "native-demo": {
        title: "Real native demonstration",
        navLabel: "Native demo",
        section: "core",
        summary: "Watch and reproduce the actual macOS filesystem, SQLite and review workflow.",
    ...
    "roadmap-execution": {
        ...
        section: "operations",
        summary: "Exact local evidence and remaining release gates.",
        source: "docs/validation/roadmap-execution.md",
        path: "docs/validation/roadmap-execution.md",
    },
    "release-notes-draft": {
        title: "Local release preparation",
        navLabel: "Release preparation",
        section: "operations",
        summary: "Unreleased fixes, local artifacts and external publication gates.",
        source: "docs/launch/release-notes-draft.md",
        path: "docs/launch/release-notes-draft.md",
    },
