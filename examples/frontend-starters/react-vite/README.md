...
Use this when you want React state and component structure but still want RustFrame to own the native desktop shell.

Suggested flow:

1. Create a RustFrame app with `cargo run -p rustframe-cli -- new my-workbench`
2. From `apps/my-workbench/`, scaffold Vite with `npm create vite@latest . -- --template react`
