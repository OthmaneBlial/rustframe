...
Use this when you want Svelte single-file components while RustFrame keeps the desktop runner hidden.

Suggested flow:

1. Create a RustFrame app with `cargo run -p rustframe-cli -- new my-workbench`
2. From `apps/my-workbench/`, scaffold Vite with `npm create vite@latest . -- --template svelte`
